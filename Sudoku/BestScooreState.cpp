...
void BestScooreState::readBestScoore()
{
	...
	bestScoore.open("C:/Users/PC/source/repos/Sudoku/Texts/Highest Score.txt");
...
{
	this->bg_text.loadFromFile("C:/Users/PC/source/repos/Sudoku/Textures/HG_sudoku_header.png");
...
void BestScooreState::initContainer()
{
	...
	this->container.setSize(sf::Vector2f(this->actuallBestScoore.getGlobalBounds().width + 10.f * this->gridSizef, this->actuallBestScoore.getGlobalBounds().height + 2.f * this->gridSizef));
}
void BestScooreState::initFont()
{
	this->buttonFont.loadFromFile("C:/Users/PC/source/repos/Sudoku/Fonts/Sudoku.ttf");
	this->bestScooreText.setFont(this->buttonFont);
	this->bestScooreText.setFillColor(sf::Color::Black);
	...
	this->bestScoorefont.loadFromFile("C:/Users/PC/source/repos/Sudoku/Fonts/Sudoku.ttf");
...
void BestScooreState::initButton()
{
	...
	this->button->setOutline(this->gridSizef);
}

//Update Functions
void BestScooreState::updateButton()
{
	if (this->button->isPressed() || sf::Keyboard::isKeyPressed(sf::Keyboard::Key(this->keyBind["CLOSE"])))
		this->endState();
}
